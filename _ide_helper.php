...
')
     ...
     */ 
         ...
         * 
         *
         * @see \OptimistDigital\NovaTranslatable\TranslatableFieldMixin::translatable()
         ...
         * 
         *
         * @see \OptimistDigital\NovaTranslatable\TranslatableFieldMixin::rulesFor()
         * @param mixed $locales
         * @param mixed $rules
         * @static 
         */ 
...
namespace  { 
            ...
            class LaravelCmd extends \KravanhEco\LaravelCmd\Facades\LaravelCmd {}
