...
final class DragonTigerGameAutoSetDefaultBetConditionAction
{
    public function __invoke(User|Member $member): void
    {
        ...
        $superSeniorCondition = app(GameDragonTigerGetTableConditionAction::class)($member->super_senior, $member->getGameTableId());
