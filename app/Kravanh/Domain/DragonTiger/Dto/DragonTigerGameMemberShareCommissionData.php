...
final class DragonTigerGameMemberShareCommissionData
{
    ...
    {
        $this->uplineShareCommission = (new DragonTigerGameMemberGetUplineShareCommissionAction())($member);
        $this->fillShareCommission();

    }

    public static function make(Member $member): DragonTigerGameMemberShareCommissionData
    {
        return new DragonTigerGameMemberShareCommissionData($member);
    }
