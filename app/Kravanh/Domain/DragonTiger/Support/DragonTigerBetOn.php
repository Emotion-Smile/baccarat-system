...
final class DragonTigerBetOn
{
    ...
    public static function make(string $betOn, string $betType): DragonTigerBetOn
    {
        return (new DragonTigerBetOn(betOn: $betOn, betType: $betType));
    }
    ...
    {
        if (!in_array($this->bet(), self::options)) {
            throw new DragonTigerGameBetOnInvalidException();
        }
    }
