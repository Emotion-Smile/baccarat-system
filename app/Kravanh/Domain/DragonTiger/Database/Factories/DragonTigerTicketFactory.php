...
class DragonTigerTicketFactory extends Factory
{
    protected $model = DragonTigerTicket::class;
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'dragon_tiger_game_id' => DragonTigerFactoryHelper::make()->dragonTigerGameId(),
            'user_id' => $member->id,
            ...
            'bet_on' => $this->faker->randomElement(['dragon', 'tiger', 'tie']),
    ...
    public function forMember(Member $member, DragonTigerGame $dragonTigerGame): DragonTigerTicketFactory
    {
