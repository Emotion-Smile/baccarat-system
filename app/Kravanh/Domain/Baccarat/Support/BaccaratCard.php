...
final class BaccaratCard
{
     ...
     * @throws BaccaratCardException
     */
    public static function make(string $type, int $number): BaccaratCard
    {

        return new BaccaratCard($type, $number);
    }
