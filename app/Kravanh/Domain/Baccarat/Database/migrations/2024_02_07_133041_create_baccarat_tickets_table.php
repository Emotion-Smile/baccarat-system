...
class CreateBaccaratTicketsTable extends Migration
{

    public function up(): void
    {
        Schema::create('baccarat_tickets', function (Blueprint $table) {

            $table->id();

            $table->foreignId('game_table_id');
            $table->foreignId('baccarat_game_id');
    ...
    {
        Schema::dropIfExists('baccarat_tickets');
    }
}
